...
### Tipado _(ayuda a TypeScript a entender el código)_
...
### Componentes _(piezas especiales que React ofrece)_
...
### Hooks _(herramientas que agregan comportamiento a los componentes)_
...
### Renderizado _(cómo React muestra los componentes en pantalla)_
...
### Elementos _(las etiquetas HTML)_
...
### Atributos _(características de las etiquetas HTML)_
...
### Accesibilidad _(ayuda a personas que utilizan tecnologías asistivas)_
...
### Layout _(cómo se organizan los elementos)_
...
### Tipos _(describen la forma de los datos)_
...
### Utilidades _(herramientas para crear nuevos tipos)_
